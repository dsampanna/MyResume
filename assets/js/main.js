...
document.getElementById('modalClose').addEventListener('click', closeHireModal);
hireModal.addEventListener('click', function(e){ if(e.target===this) closeHireModal(); });
document.getElementById('modalContactLink').addEventListener('click', closeHireModal);
/* Escape key closes modal */
document.addEventListener('keydown', function(e){ if(e.key==='Escape' && hireModal.classList.contains('open')) closeHireModal(); });
...
/* BTT + Features 11-17 + page transitions live in shared.js */
