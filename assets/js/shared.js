...
(function(){
  if(!document.getElementById('bttStyle')){
    ...
    s.textContent =
      ...
      'background:transparent;color:#0EB5A0;border:5px solid rgba(14,181,160,0.5);border-radius:50%;' +
      ...
      '#btt:hover{color:#0cc9b2;border-width:6px;border-color:rgba(14,181,160,0.85);background:transparent;' +
